...
- **Component**:
  ...
  - **Additional Information**:
    ...
    - Extended HTML Element attributes of elements used within parent tags to allow components to receive more attributes than set by the component. This allows working with Microdata when creating FAQs.
